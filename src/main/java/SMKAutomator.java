...
public class SMKAutomator {
    ...
    public static void navigateNonRTGForm() throws InterruptedException {
    ...
    public static void input() {
        ...
        XMLReader.getNonRTG().forEach(procedure -> {
            driver.findElement(By.xpath("(//input[contains(@type,'textArea')])[1]")).sendKeys(procedure.getDate().toString());
            ...
            driver.findElement(By.xpath("(//input[contains(@type,'textArea')])[2]")).sendKeys("Łukasz Gościcki");
            driver.findElement(By.xpath("(//select[contains(@tabindex,'-1')])[3]")).sendKeys("Z");
            driver.findElement(By.xpath("(//select[contains(@tabindex,'-1')])[4]")).sendKeys(Keys.PAGE_DOWN);
            driver.findElement(By.xpath("(//input[contains(@type,'textArea')])[3]")).sendKeys(procedure.getPatientInitials());
            driver.findElement(By.xpath("(//select[contains(@tabindex,'-1')])[5]")).sendKeys(procedure.getSex());
            driver.findElement(By.xpath("(//input[contains(@type,'textArea')])[5]")).sendKeys(procedure.getProcedureName());
            driver.findElement(By.xpath("(//button[contains(@type,'button')])[37]")).click();
        });
    }
